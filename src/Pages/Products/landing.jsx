...
const Landing = () => {
  return (
    <div className="text-center mx-auto mt-40 border-b border-zinc-200 w-300">
        <h1 className="text-5xl font-medium my-5">Zerodha Products</h1>
        <p className="text-xl my-5">Sleek, modern, and intuitive trading platforms</p>
