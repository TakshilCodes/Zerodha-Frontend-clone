    ...
    <div className="mt-32 mb-20 flex flex-col md:flex-row justify-center items-center">
        <div>
            ...
            <div className="sections mt-10">
                ...
                <p className="text-[#666]">That's why 1.5+ crore customers trust Zerodha with <br />
            ...
            <div className="sections">
                ...
                <p className="text-[#666]">No gimmicks, spam, "gamification", or annoying push <br />
            ...
            <div className="sections">
                ...
                <p className="text-[#666]">Not just an app, but a whole ecosystem. Our investments <br />
            ...
            <div className="sections">
                ...
                <p className="text-[#666]">With initiatives like Nudge and Kill Switch, we don't just <br /> 
